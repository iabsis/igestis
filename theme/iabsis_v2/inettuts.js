var iNettuts = {
    ...
    makeSortable : function () {
        ...
        $sortableItems.find(settings.handleSelector).css({
            ...
            INettutsCurrentDrag = $(this).parent().attr("class");
        });
    ...
    savePreferences : function () {
        ...
        $(settings.columns).each(function(i){            
            $(settings.widgetSelector,this).each(function(i){
                ...
                if( INettutsCurrentDrag.indexOf($(this).attr('class')) != -1) {
                    save_position($(this).attr('class'), i+1, column);
                }
...
function save_position(id, row, column) {
    //alert("Position for " + id + ":\nRow=" + row + "\nColoumn=" + column);
    xajax_applet_save_position(id, row, column);
}

var INettutsCurrentDrag = "";