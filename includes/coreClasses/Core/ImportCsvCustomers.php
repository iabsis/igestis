...
/**
 * Manage the import of the customers
 *
 * @author Gilles Hemmerlé (iabsis) <giloux@gmail.com>
 */

class ImportCsvCustomers extends \Igestis\Apis\ImportCsvDatas {
        ...
        if(in_array($row['infos']['lineId'], $linesToValide)) {            
            ...
            if($contact == null) {
                ...
                if($user->getUserType() != "client") {
                    throw new Exception(_("This login is already associated to an employee"));
                }
            }
