...
!function ($) {
  ...
  * ================================= */
  ...
  var Fileupload = function (element, options) {
    ...
    this.$element.find('[data-trigger="jasnyFileupload"]').on('click.jasnyFileupload', $.proxy(this.trigger, this))
  ...
  Fileupload.prototype = {
    ...
    listen: function() {
      this.$input.on('change.jasnyFileupload', $.proxy(this.change, this))
      $(this.$input[0].form).on('reset.jasnyFileupload', $.proxy(this.reset, this))
      if (this.$remove) this.$remove.on('click.jasnyFileupload', $.proxy(this.clear, this))
    },
  ...
  * =========================== */
  ...
  $.fn.jasnyFileupload = function (options) {
    return this.each(function () {
      var $this = $(this)
      , data = $this.data('jasnyFileupload')
      if (!data) $this.data('jasnyFileupload', (data = new Fileupload(this, options)))
      if (typeof options == 'string') data[options]()
    })
  }

  $.fn.jasnyFileupload.Constructor = Fileupload


 /* FILEUPLOAD DATA-API
  * ================== */

  $(document).on('click.jasnyFileupload.data-api', '[data-provides="fileupload"]', function (e) {
    var $this = $(this)
    console.log($this);
    if ($this.data('jasnyFileupload')) return
    $this.jasnyFileupload($this.data())
      
    var $target = $(e.target).closest('[data-dismiss="fileupload"],[data-trigger="fileupload"]');
    if ($target.length > 0) {
      $target.trigger('click.jasnyFileupload')
      e.preventDefault()
    }
  })
